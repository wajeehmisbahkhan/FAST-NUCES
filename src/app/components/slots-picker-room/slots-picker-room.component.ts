...
@Component({
  selector: 'app-slots-picker-room',
  templateUrl: './slots-picker-room.component.html',
  styleUrls: ['./slots-picker-room.component.scss']
})
export class SlotsPickerRoomComponent implements OnInit {
